...
export const createUser = async (payload: CreateUserPayload): Promise<IUserDocument> =>
...
export const findUserBySyncApiKey = async (syncApiKey: string): Promise<IUserDocument | null> =>
  UserModel.findOne({ syncApiKey }).exec();
