    ...
    actors: [
      {
        ...
        type: { type: String, enum: ["HUMAN", "SYSTEM", "EXTERNAL_SERVICE"], required: true },
    ...
    dependencies: [
      {
        ...
        type: { type: String, enum: ["BLOCKING", "EXTERNAL", "OPTIONAL"], required: true },
    ...
    risks: [
      {
        ...
        type: {
          type: String,
          enum: ["TECHNICAL", "INTEGRATION", "REQUIREMENTS", "TIMELINE", "SCALABILITY"],
          required: true,
        },
