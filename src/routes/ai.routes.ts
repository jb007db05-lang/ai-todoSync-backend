...
class CentralizedAiRoutes implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get("/workspace-sessions", aiPlanningController.listWorkspaceSessions);
    this.router.post("/workspace-sessions", aiPlanningController.createWorkspaceSession);
    this.router.get("/workspace-sessions/:sessionId", aiPlanningController.getWorkspaceSession);
    this.router.delete("/workspace-sessions/:sessionId", aiPlanningController.deleteWorkspaceSession);
